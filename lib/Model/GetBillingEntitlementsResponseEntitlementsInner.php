...
/**
 * GetBillingEntitlementsResponseEntitlementsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetBillingEntitlementsResponseEntitlementsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_billing_entitlements_response_entitlements_inner';
    ...
    protected static array $openAPINullables = [
        ...
        'feature_code' => false,
        'feature_name' => false,
        'entitlement_limit_max' => false,
        'entitlement_limit_min' => false
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('feature_code', $data ?? [], null);
    ...
    */
    ...
    public function setFixedCharge($fixed_charge)
    {
        if (is_null($fixed_charge)) {
            throw new \InvalidArgumentException('non-nullable fixed_charge cannot be null');
        }
    ...
    {
        return $this->container['feature_code'];
    }

    /**
     * Sets feature_code
     *
     * @param string|null $feature_code The feature code of the feature corresponding to this entitlement
     *
     * @return self
     */
    public function setFeatureCode($feature_code)
    {
        if (is_null($feature_code)) {
            throw new \InvalidArgumentException('non-nullable feature_code cannot be null');
        }
        $this->container['feature_code'] = $feature_code;
     ...
     * Sets feature_name
     *
     * @param string|null $feature_name The feature name of the feature corresponding to this entitlement
     *
     * @return self
     */
    ...
    public function setEntitlementLimitMax($entitlement_limit_max)
    {
        if (is_null($entitlement_limit_max)) {
            throw new \InvalidArgumentException('non-nullable entitlement_limit_max cannot be null');
        }
    ...
    public function setEntitlementLimitMin($entitlement_limit_min)
    {
        if (is_null($entitlement_limit_min)) {
            throw new \InvalidArgumentException('non-nullable entitlement_limit_min cannot be null');
        }
