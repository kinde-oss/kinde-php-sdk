...
/**
 * CreateConnectionRequestOptionsOneOf Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateConnectionRequestOptionsOneOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateConnection_request_options_oneOf';
    ...
    */
     ...
     * Sets client_id
     *
     * @param string|null $client_id OAuth client ID.
     *
     * @return self
     */
     ...
     * Sets client_secret
     *
     * @param string|null $client_secret OAuth client secret.
     *
     * @return self
     */
