...
/**
 * GetEntitlementsResponseData Class Doc Comment
 *
 * @category Class
 * @package  Kinde\KindeSDK
 * @author   OpenAPI Generator team
 ...
 */
class GetEntitlementsResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_entitlements_response_data';
    ...
    */
     ...
     * Sets org_code
     *
     * @param string|null $org_code The organization code the entitlements are associated with.
     *
     * @return self
     */
