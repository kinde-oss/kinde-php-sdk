...
/**
 * GetUserPermissionsResponseData Class Doc Comment
 *
 * @category Class
 * @package  Kinde\KindeSDK
 * @author   OpenAPI Generator team
 ...
 */
class GetUserPermissionsResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_user_permissions_response_data';
    ...
    */
     ...
     * Sets org_code
     *
     * @param string|null $org_code The organization code the roles are associated with.
     *
     * @return self
     */
