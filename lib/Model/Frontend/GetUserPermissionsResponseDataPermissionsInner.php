...
/**
 * GetUserPermissionsResponseDataPermissionsInner Class Doc Comment
 *
 * @category Class
 * @package  Kinde\KindeSDK
 * @author   OpenAPI Generator team
 ...
 */
class GetUserPermissionsResponseDataPermissionsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_user_permissions_response_data_permissions_inner';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The friendly ID of a permission
     *
     * @return self
     */
     ...
     * Sets key
     *
     * @param string|null $key The key of the permission
     *
     * @return self
     */
