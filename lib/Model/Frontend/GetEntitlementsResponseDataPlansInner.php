...
/**
 * GetEntitlementsResponseDataPlansInner Class Doc Comment
 *
 * @category Class
 * @package  Kinde\KindeSDK
 * @author   OpenAPI Generator team
 ...
 */
class GetEntitlementsResponseDataPlansInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_entitlements_response_data_plans_inner';
    ...
    */
     ...
     * Sets key
     *
     * @param string|null $key A unique code for the plan
     *
     * @return self
     */
     ...
     * Sets subscribed_on
     *
     * @param \DateTime|null $subscribed_on The date the user subscribed to the plan
     *
     * @return self
     */
