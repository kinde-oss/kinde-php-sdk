 ...
 */
class PortalLink implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'portal_link';
    ...
    */
     ...
     * Sets url
     *
     * @param string|null $url Unique URL to redirect the user to.
     *
     * @return self
     */
