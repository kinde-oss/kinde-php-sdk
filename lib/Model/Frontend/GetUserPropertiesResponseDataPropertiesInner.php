...
/**
 * GetUserPropertiesResponseDataPropertiesInner Class Doc Comment
 *
 * @category Class
 * @package  Kinde\KindeSDK
 * @author   OpenAPI Generator team
 ...
 */
class GetUserPropertiesResponseDataPropertiesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_user_properties_response_data_properties_inner';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The friendly ID of a property
     *
     * @return self
     */
     ...
     * Sets key
     *
     * @param string|null $key The key of the property
     *
     * @return self
     */
