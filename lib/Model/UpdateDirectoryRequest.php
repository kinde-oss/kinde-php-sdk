...
/**
 * UpdateDirectoryRequest Class Doc Comment
 *
 * @category Class
 * @package  Kinde\KindeSDK
 * @author   OpenAPI Generator team
 ...
 */
class UpdateDirectoryRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateDirectory_request';
    ...
    */
     ...
     * Sets directory_name
     *
     * @param string|null $directory_name A descriptive name for the SCIM directory.
     *
     * @return self
     */
