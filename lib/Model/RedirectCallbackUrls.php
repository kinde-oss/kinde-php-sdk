...
/**
 * RedirectCallbackUrls Class Doc Comment
 *
 * @category Class
 * @package  Kinde\KindeSDK
 * @author   OpenAPI Generator team
 ...
 */
class RedirectCallbackUrls implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'redirect_callback_urls';
     ...
     * Sets redirect_urls
     *
     * @param string[]|null $redirect_urls An application's redirect URLs.
     *
     * @return self
     */
