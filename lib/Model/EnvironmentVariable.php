...
class EnvironmentVariable implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'environment_variable';
    ...
    */
     ...
     * Sets key
     *
     * @param string|null $key The name of the environment variable.
     *
     * @return self
     */
     ...
     * Sets is_secret
     *
     * @param bool|null $is_secret Whether the environment variable is sensitive.
     *
     * @return self
     */
     ...
     * Sets created_on
     *
     * @param string|null $created_on The date the environment variable was created.
     *
     * @return self
     */
