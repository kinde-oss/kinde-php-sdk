...
class User implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'billing' => '\Kinde\KindeSDK\Model\UserBilling'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('preferred_email', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($preferred_email)) {
            throw new \InvalidArgumentException('non-nullable preferred_email cannot be null');
        }
     ...
     * Gets billing
     *
     * @return \Kinde\KindeSDK\Model\UserBilling|null
     */
     ...
     * Sets billing
     *
     * @param \Kinde\KindeSDK\Model\UserBilling|null $billing billing
     *
     * @return self
     */
