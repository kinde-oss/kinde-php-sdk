...
/**
 * GetEnvironmentResponseEnvironmentBackgroundColor Class Doc Comment
 *
 * @category Class
 * @package  Kinde\KindeSDK
 * @author   OpenAPI Generator team
 ...
 */
class GetEnvironmentResponseEnvironmentBackgroundColor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_environment_response_environment_background_color';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('hsl', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['hsl'];
    }

    /**
     * Sets hsl
     *
     * @param string|null $hsl hsl
     *
     * @return self
     */
    ...
    {
        if (is_null($hsl)) {
            throw new \InvalidArgumentException('non-nullable hsl cannot be null');
        }
        $this->container['hsl'] = $hsl;
