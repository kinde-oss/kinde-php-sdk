 ...
 */
class OrganizationUserRolePermissions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'organization_user_role_permissions';
