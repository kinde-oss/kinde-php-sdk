...
/**
 * GetPasskey200Response Class Doc Comment
 *
 * @category Class
 * @package  Kinde\KindeSDK
 * @author   OpenAPI Generator team
 ...
 */
class GetPasskey200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetPasskey_200_response';
    ...
    */
     ...
     * Sets enabled
     *
     * @param bool|null $enabled Whether passkeys are enabled for this environment (`policy` is not `off`).
     *
     * @return self
     */
     ...
     * Sets policy
     *
     * @param string|null $policy Environment passkey policy. `off` disables passkeys; `optional` enables passkeys and allows users to skip passkey setup after password sign-in; `mandatory` requires passkey setup after first password sign-in.
     *
     * @return self
     */
