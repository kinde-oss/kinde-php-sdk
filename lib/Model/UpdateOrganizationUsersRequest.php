 ...
 */
class UpdateOrganizationUsersRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateOrganizationUsers_request';
