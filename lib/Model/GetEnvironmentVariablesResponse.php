 ...
 */
class GetEnvironmentVariablesResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_environment_variables_response';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('environment_variables', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($environment_variables)) {
            throw new \InvalidArgumentException('non-nullable environment_variables cannot be null');
        }
