 ...
 */
class GetEnvironmentFeatureFlagsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_environment_feature_flags_response';
