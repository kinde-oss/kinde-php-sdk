 ...
 */
class GetBillingEntitlementsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_billing_entitlements_response';
