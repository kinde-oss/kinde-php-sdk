...
/**
 * SearchUsersResponseResultsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SearchUsersResponseResultsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'search_users_response_results_inner';
    ...
    */
     ...
     * Sets properties
     *
     * @param array<string,string>|null $properties The user properties.
     *
     * @return self
     */
