 ...
 */
class GetRedirectCallbackUrlsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_redirect_callback_urls_response';
