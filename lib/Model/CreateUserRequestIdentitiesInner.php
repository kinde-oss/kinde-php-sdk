 ...
 */
class CreateUserRequestIdentitiesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createUser_request_identities_inner';
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type The type of identity to create, e.g. email, username, or phone.
     *
     * @return self
     */
     ...
     * Sets is_verified
     *
     * @param bool|null $is_verified Set whether an email or phone identity is verified or not.
     *
     * @return self
     */
