...
/**
 * CreateRoleRequest Class Doc Comment
 *
 * @category Class
 * @package  Kinde\KindeSDK
 * @author   OpenAPI Generator team
 ...
 */
class CreateRoleRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateRole_request';
    ...
    */
     ...
     *
     * @param string|null $assignment_permission_id The public ID of the permission required to assign this role to users. If null, no permission is required.
     *
     * @return self
     */
