...
/**
 * GetOrganizationResponseBillingAgreementsInner Class Doc Comment
 *
 * @category Class
 * @package  Kinde\KindeSDK
 * @author   OpenAPI Generator team
 ...
 */
class GetOrganizationResponseBillingAgreementsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_organization_response_billing_agreements_inner';
    ...
    */
     ...
     * Sets plan_code
     *
     * @param string|null $plan_code The code of the plan from which this agreement is taken from
     *
     * @return self
     */
     ...
     * Sets agreement_id
     *
     * @param string|null $agreement_id The id of the billing agreement in Kinde
     *
     * @return self
     */
