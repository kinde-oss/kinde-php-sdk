...
class OrganizationsApi
{
     ...
     * @throws \Kinde\KindeSDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Kinde\KindeSDK\Model\GetOrgainzations200Response
     */
    public function getOrgainzations($sort = null, $page_size = null, $next_token = null)
    {
        list($response) = $this->getOrgainzationsWithHttpInfo($sort, $page_size, $next_token);
        return $response;
    }

    /**
     * Operation getOrgainzationsWithHttpInfo
     *
     * List Organizations
     *
     * @param  string $sort Field and order to sort the result by. (optional)
     ...
     * @throws \Kinde\KindeSDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Kinde\KindeSDK\Model\GetOrgainzations200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrgainzationsWithHttpInfo($sort = null, $page_size = null, $next_token = null)
    {
        $request = $this->getOrgainzationsRequest($sort, $page_size, $next_token);
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Kinde\KindeSDK\Model\GetOrgainzations200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Kinde\KindeSDK\Model\GetOrgainzations200Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Kinde\KindeSDK\Model\GetOrgainzations200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Kinde\KindeSDK\Model\GetOrgainzations200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Kinde\KindeSDK\Model\GetOrgainzations200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getOrgainzationsAsync
     *
     * List Organizations
     *
     * @param  string $sort Field and order to sort the result by. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrgainzationsAsync($sort = null, $page_size = null, $next_token = null)
    {
        return $this->getOrgainzationsAsyncWithHttpInfo($sort, $page_size, $next_token)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getOrgainzationsAsyncWithHttpInfo
     *
     * List Organizations
     *
     * @param  string $sort Field and order to sort the result by. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrgainzationsAsyncWithHttpInfo($sort = null, $page_size = null, $next_token = null)
    {
        $returnType = '\Kinde\KindeSDK\Model\GetOrgainzations200Response';
        $request = $this->getOrgainzationsRequest($sort, $page_size, $next_token);
    ...
    /**
     * Create request for operation 'getOrgainzations'
     *
     * @param  string $sort Field and order to sort the result by. (optional)
     * @param  int $page_size Number of results per page. Defaults to 10 if parameter not sent. (optional)
     * @param  string $next_token A string to get the next page of results if there are more results. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getOrgainzationsRequest($sort = null, $page_size = null, $next_token = null)
    {
