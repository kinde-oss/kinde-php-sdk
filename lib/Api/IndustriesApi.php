...
class IndustriesApi
{
     ...
     *
     * @param  string $industry_key Industry Key. (optional)
     * @param  string $name Industry name. (optional)
     *
     * @throws \Kinde\KindeSDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Kinde\KindeSDK\Model\SuccessResponse
     */
    public function getIndustries($industry_key = null, $name = null)
    {
        list($response) = $this->getIndustriesWithHttpInfo($industry_key, $name);
        return $response;
    }
     ...
     */
    public function getIndustriesWithHttpInfo($industry_key = null, $name = null)
    {
        $request = $this->getIndustriesRequest($industry_key, $name);
     ...
     */
    public function getIndustriesAsync($industry_key = null, $name = null)
    {
        return $this->getIndustriesAsyncWithHttpInfo($industry_key, $name)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getIndustriesAsyncWithHttpInfo($industry_key = null, $name = null)
    {
        $returnType = '\Kinde\KindeSDK\Model\SuccessResponse';
        $request = $this->getIndustriesRequest($industry_key, $name);
     ...
     */
    public function getIndustriesRequest($industry_key = null, $name = null)
    {
