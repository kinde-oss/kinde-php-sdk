...
class IdentitiesApi
{
    ...
    {
        list($response) = $this->deleteIdentityWithHttpInfo($identity_id, $contentType);
        return $response;
    }
    ...
    public function deleteIdentityRequest($identity_id, string $contentType = self::contentTypes['deleteIdentity'][0])
    {
        ...
        $resourcePath = '/api/v1/identities/{identity_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->getIdentityWithHttpInfo($identity_id, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getIdentityAsync($identity_id, string $contentType = self::contentTypes['getIdentity'][0])
    {
        return $this->getIdentityAsyncWithHttpInfo($identity_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getIdentityRequest($identity_id, string $contentType = self::contentTypes['getIdentity'][0])
    {
    ...
    {
        list($response) = $this->updateIdentityWithHttpInfo($identity_id, $update_identity_request, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateIdentityAsync($identity_id, $update_identity_request, string $contentType = self::contentTypes['updateIdentity'][0])
    {
        return $this->updateIdentityAsyncWithHttpInfo($identity_id, $update_identity_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateIdentityRequest($identity_id, $update_identity_request, string $contentType = self::contentTypes['updateIdentity'][0])
    {
        ...
        if ($update_identity_request === null || (is_array($update_identity_request) && count($update_identity_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $update_identity_request when calling updateIdentity'
            );
        }
        ...
        if (isset($update_identity_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($update_identity_request));
            } else {
