...
class TimezonesApi
{
     ...
     * @return \Kinde\KindeSDK\Model\GetTimezonesResponse|\Kinde\KindeSDK\Model\ErrorResponse|\Kinde\KindeSDK\Model\ErrorResponse|\Kinde\KindeSDK\Model\ErrorResponse
     */
     ...
     * @throws \Kinde\KindeSDK\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Kinde\KindeSDK\Model\GetTimezonesResponse|\Kinde\KindeSDK\Model\ErrorResponse|\Kinde\KindeSDK\Model\ErrorResponse|\Kinde\KindeSDK\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Kinde\KindeSDK\Model\GetTimezonesResponse',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\Kinde\KindeSDK\Model\GetTimezonesResponse';
        $request = $this->getTimezonesRequest($contentType);
