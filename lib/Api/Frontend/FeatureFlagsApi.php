...
class FeatureFlagsApi
{
     ...
     * @param  string|null $starting_after The ID of the flag to start after. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getFeatureFlags'] to see the possible values for this operation
     *
    ...
    {
        list($response) = $this->getFeatureFlagsWithHttpInfo($page_size, $starting_after, $contentType);
        return $response;
    }
     ...
     */
    public function getFeatureFlagsAsync($page_size = null, $starting_after = null, string $contentType = self::contentTypes['getFeatureFlags'][0])
    {
        return $this->getFeatureFlagsAsyncWithHttpInfo($page_size, $starting_after, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    public function getFeatureFlagsRequest($page_size = null, $starting_after = null, string $contentType = self::contentTypes['getFeatureFlags'][0])
    {




        $resourcePath = '/account_api/v1/feature_flags';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
