...
class EnvironmentsApi
{
     ...
     */
    public function getEnvironementFeatureFlags()
    {
        list($response) = $this->getEnvironementFeatureFlagsWithHttpInfo();
        return $response;
    }
     ...
     */
    public function getEnvironementFeatureFlagsWithHttpInfo()
    {
        $request = $this->getEnvironementFeatureFlagsRequest();
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Kinde\KindeSDK\Model\GetEnvironmentFeatureFlagsResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Kinde\KindeSDK\Model\GetEnvironmentFeatureFlagsResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Kinde\KindeSDK\Model\GetEnvironmentFeatureFlagsResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEnvironementFeatureFlagsAsync()
    {
        return $this->getEnvironementFeatureFlagsAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEnvironementFeatureFlagsAsyncWithHttpInfo()
    {
        $returnType = '\Kinde\KindeSDK\Model\GetEnvironmentFeatureFlagsResponse';
        $request = $this->getEnvironementFeatureFlagsRequest();
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getEnvironementFeatureFlagsRequest()
    {
     ...
     * @return \Kinde\KindeSDK\Model\SuccessResponse|\Kinde\KindeSDK\Model\ErrorResponse
     */
    public function updateEnvironementFeatureFlagOverride($feature_flag_key, $update_environement_feature_flag_override_request)
    {
        list($response) = $this->updateEnvironementFeatureFlagOverrideWithHttpInfo($feature_flag_key, $update_environement_feature_flag_override_request);
        return $response;
    }
     ...
     * @return array of \Kinde\KindeSDK\Model\SuccessResponse|\Kinde\KindeSDK\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateEnvironementFeatureFlagOverrideWithHttpInfo($feature_flag_key, $update_environement_feature_flag_override_request)
    {
        $request = $this->updateEnvironementFeatureFlagOverrideRequest($feature_flag_key, $update_environement_feature_flag_override_request);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateEnvironementFeatureFlagOverrideAsync($feature_flag_key, $update_environement_feature_flag_override_request)
    {
        return $this->updateEnvironementFeatureFlagOverrideAsyncWithHttpInfo($feature_flag_key, $update_environement_feature_flag_override_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateEnvironementFeatureFlagOverrideAsyncWithHttpInfo($feature_flag_key, $update_environement_feature_flag_override_request)
    {
        $returnType = '\Kinde\KindeSDK\Model\SuccessResponse';
        $request = $this->updateEnvironementFeatureFlagOverrideRequest($feature_flag_key, $update_environement_feature_flag_override_request);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateEnvironementFeatureFlagOverrideRequest($feature_flag_key, $update_environement_feature_flag_override_request)
    {
        // verify the required parameter 'feature_flag_key' is set
        if ($feature_flag_key === null || (is_array($feature_flag_key) && count($feature_flag_key) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if (isset($update_environement_feature_flag_override_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($update_environement_feature_flag_override_request));
            } else {
