        ...
        <div class="content">
            ...
            <div class="header-fix-status {{ $headerFixStatus['working'] === true ? 'working' : ($headerFixStatus['working'] === false ? 'not-working' : '') }}">
                ...
                <p><strong>Status:</strong> 
                    @if($headerFixStatus['working'] === true)
                        ✅ Working
                    @elseif($headerFixStatus['working'] === false)
                        ❌ Not Working
                    @else
                        ⚠️ Unknown
                    @endif
                </p>
                <p><strong>Message:</strong> {{ $headerFixStatus['message'] }}</p>
                @if(isset($headerFixStatus['test_call']))
                    <p><strong>Test Call:</strong> {{ $headerFixStatus['test_call'] }}</p>
                @endif
                @if(isset($headerFixStatus['error']))
                    <p><strong>Error:</strong> <code>{{ $headerFixStatus['error'] }}</code></p>
                @endif
            </div>
            ...
            <div class="test-results">
                @foreach($testResults as $endpoint => $result)
                    <div class="test-card {{ $result['success'] ? 'success' : 'failed' }}">
                        ...
                        <div class="test-body">
                            ...
                            @else
                                ...
                                <div class="test-info">
                                    <strong>Error Code:</strong> {{ $result['code'] ?? 'N/A' }}
                                </div>
