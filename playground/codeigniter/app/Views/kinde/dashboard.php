    ...
    <main class="flex-1 p-8">
        <div class="max-w-6xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <!-- Has Functionality Testing -->
                <div class="bg-white shadow rounded-lg p-6">
                    <h3 class="text-lg font-semibold mb-4 text-emerald-600">🧪 Has Functionality</h3>
                    <div class="space-y-2">
                        <a href="/test-has-functionality" class="block text-emerald-600 hover:text-emerald-800 font-semibold">🎯 Test Has Methods</a>
                        <div class="text-sm text-gray-600 mt-2">
                            Comprehensive testing of new authorization checking methods
                        </div>
                    </div>
                </div>
