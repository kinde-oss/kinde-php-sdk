...
| grantType                       | string  | Yes                                     |                              | The grant type to define is the flow that will be used.<br /> - Authorization Code: GrantType::authorizationCode<br />Intended for confidential clients, e.g. web-servers.<br />- Authorization Code with PKCE: GrantType::PKCE<br />Extension for public clients, e.g. single page web applications and mobile applications, and confidential clients, e.g. web-servers.<br />- Client Credentials Flow: GrantType::clientCredentials<br />Intended for confidential clients where machine-to-machine communication is required.                |
